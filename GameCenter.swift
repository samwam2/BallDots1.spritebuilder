...
//  BallDots
//
//  Created by Sam Showalter on 8/9/15.
...
protocol GameCenterInteractorNotifications { func willSignIn(); func didSignIn(); func failedToSignInWithError(anError:NSError); func failedToSignIn() }
